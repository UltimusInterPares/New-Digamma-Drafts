...
\subsection{Elision}\label{subsec:Elision}
    ...
    \textel{``Ἡφαίστοιο ἄνακτος''},\autocite[\MakeUppercase{\romannumeral 15}.214]{Iliad_1999} without any contraction between the genitive ending
...
\subsection{Meter}\label{subsec:Meter}
    ...
    Even though in typical orthography, the omicron \ortho{\textel{ο}} exclusively encodes the short vowel \phonem{o}.
    ...
    epsilon \ortho{\textel{ε}} which, as with \textel{ἀπὸ}, scans as long by position.\autocite[\MakeUppercase{\romannumeral 1}.33]{Iliad_1999}
