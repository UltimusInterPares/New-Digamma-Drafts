...
\usepackage{units} % for nicer fraction
    ...
    \newcommand{\eo}{$\nicefrac{\textrm{\textel{ε}}}{\textrm{\textel{ο}}}$}
    
% Greek Roots
\newcommand{\groot}[1]{$\sqrt{\textrm{\textel{#1}}}$}
\newcommand{\gstem}[1]{$\sqrt[\textrm{stem}]{\textrm{\textel{#1}}}$}

\newcommand{\lroot}[1]{$\sqrt{\textrm{#1}}$}
\newcommand{\lstem}[1]{$\sqrt[\textrm{stem}]{\textrm{#1}}$}
